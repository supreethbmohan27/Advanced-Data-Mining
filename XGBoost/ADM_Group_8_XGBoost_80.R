#XGBoost with 80-20 split without Age and Menopause features
...
#Apply mean function for required attributes to take mean values which cell or value is empty or null
